...
public class ProductRepository {
	...
	public Product findProductByProductName(String productName) {
		...
		try {
			...
			if (rs.next()) {
				product = Product.builder().productId(rs.getInt(1)).productName(rs.getString(2))
						.productPrice(rs.getInt(3)).productColorId(rs.getInt(4))
						.productColor(ProductColor.builder().productColorId(rs.getInt(4))
								.productColorName(rs.getString(5)).build())
						.productCategoryId(rs.getInt(6)).productCategory(ProductCategory.builder()
								.productCategoryId(rs.getInt(6)).productCategoryName(rs.getString(7)).build())
						.build();
			}
	...
	public List<Product> getSearchProductList(String searchOption, String searchValue) {
		...
		try {
			...
			while(rs.next()) {
					Product product = Product.builder().productId(rs.getInt(1)).productName(rs.getString(2))
							.productPrice(rs.getInt(3)).productColorId(rs.getInt(4))
							.productColor(ProductColor.builder().productColorId(rs.getInt(4))
									.productColorName(rs.getString(5)).build())
							.productCategoryId(rs.getInt(6)).productCategory(ProductCategory.builder()
